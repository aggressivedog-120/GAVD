...
data_train, data_test = gd.eg3(N_train=N_train, N_test=N_test, depend_ratio_train=depend_r_train, depend_ratio_test=depend_r_test, feature_num=f_n, stable_ratio=0.4)
