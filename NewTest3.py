...
for data_train in data_train_list[:1]:
    ...
    plt.title("The convergency state during iterations n={}_p={}_r={}".format(n, p, r))
    plt.legend()
    plt.show()
    ...
    plt.title("The w during iterations n={}_p={}_r={}".format(n, p, r))
    plt.legend()
    plt.show()
    ...
    plt.colorbar()
    plt.title('corr without weight n={}_p={}_r={}'.format(n, p, r))
    plt.show()

    plt.figure()
    plt.imshow(corr_weighted, cmap=plt.cm.Reds, origin='lower')
    plt.colorbar()
    plt.title('corr with weight n={}_p={}_r={}'.format(n, p, r))
    plt.show()
...
with open(os.path.join(store_path, 'result_n={}_p={}_r={}'.format(n, p, r)), 'wb') as f:
